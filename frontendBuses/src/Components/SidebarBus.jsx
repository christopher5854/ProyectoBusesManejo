...
const menuItems = [
  {
    section: 'Operaciones',
    items: [
      { label: 'Escáner QR', icon: 'ti-qrcode', path: '/bus/escaneo' },
      { label: 'Mapa de asientos', icon: 'ti-chair-director', path: '/bus/mapa-asientos' },
      { label: 'Control de paradas', icon: 'ti-map-pin', path: '/bus/control-paradas' },
    ]
  },
  {
    section: 'Ventas en ruta',
    items: [
      { label: 'Vender boleto', icon: 'ti-ticket', path: '/bus/vender-boleto' },
    ]
  },
  {
    section: 'Cierre',
    items: [
      { label: 'Reporte de viaje', icon: 'ti-file-report', path: '/bus/reporte' },
    ]
  }
];

export default function SidebarBus() {
        ...
        {!collapsed && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: '10px', color: '#6b7280' }}>Chofer</p>
            </div>
          </div>
        )}
        <button
      ...
      <div style={{
        ...
        {!collapsed && (
          <div style={{ flex: 1, minWidth: 0 }}>
            <p style={{ margin: 0, fontSize: '12px', fontWeight: 500, color: '#f9fafb', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Chofer</p>
            <p style={{ margin: 0, fontSize: '11px', color: '#6b7280' }}>chofer@pelileo.ec</p>
          </div>
        )}
        {!collapsed && (
