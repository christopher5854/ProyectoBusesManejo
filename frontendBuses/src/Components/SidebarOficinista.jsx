...
const menuItems = [
  {
    section: 'Principal',
    items: [
      { label: 'Dashboard', icon: 'ti-layout-dashboard', path: '/oficinista/dashboard' },
      { label: 'Vender boleto', icon: 'ti-shopping-cart', path: '/oficinista/venta-boletos' },
    ]
  },
  {
    section: 'Operaciones',
    items: [
      { label: 'Rutas del día', icon: 'ti-clock', path: '/oficinista/rutas-dia' },
      { label: 'Pagos pendientes', icon: 'ti-credit-card', path: '/oficinista/pagos-pendientes' },
    ]
  },
  {
    section: 'Buses',
    items: [
      { label: 'Estado de buses', icon: 'ti-bus', path: '/oficinista/estado-buses' },
    ]
  }
];

export default function SidebarOficinista() {
        ...
        {!collapsed && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: '10px', color: '#6b7280' }}>Oficinista</p>
            </div>
          </div>
        )}
        <button
      ...
      <div style={{
        ...
        {!collapsed && (
          <div style={{ flex: 1, minWidth: 0 }}>
            <p style={{ margin: 0, fontSize: '12px', fontWeight: 500, color: '#f9fafb', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Oficinista</p>
            <p style={{ margin: 0, fontSize: '11px', color: '#6b7280' }}>oficina@pelileo.ec</p>
          </div>
        )}
        {!collapsed && (
